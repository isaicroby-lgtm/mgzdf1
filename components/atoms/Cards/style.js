...
${({ is }) =>
  is === "n-individual-product" &&
  `box-shadow: 0 1px 2px 0 ${theme["border-color-light"]}, 0 1px 6px -1px ${theme["border-color-light"]}, 0 2px 4px 0 ${theme["border-color-light"]}; !important`}
